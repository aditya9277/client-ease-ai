...
const AgentDashboard = () => {
  ...
  return (
    <div className="space-y-4 p-3 min-h-screen bg-gradient-to-b from-slate-100 to-slate-50">
      <div className="flex items-center justify-between p-4 rounded-xl border border-slate-200 bg-white shadow-sm">
        <div className="space-y-1">
          <h2 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary via-info to-accent">
        ...
        <div className="flex items-center">
          <div className="mr-4 flex items-center">
            <span className="text-slate-700 text-sm font-medium mr-2">
              Click here to test our prototype!
            </span>
